...
即使凑全了, 美国TI和ADI新设计的大规模集成5G射频芯片一出来, 原有的设计就完全过时了. 其他部分应该问题不大, 虽然现在系统用了Xilinx的FPGA, 应该可以把逻辑重新合成, 做成一颗ASIC取代. 
...
<br />b. 上面谈到的那一篇文章, 可以作为5G基站芯片的基本架构, 从4G到5G改变了什么? 
         ...
         这次让我开眼的是美国公司居然能把这样的产品商业化, 做得这么小这么便宜. 
...
在这个标准里使用了相控数组雷达的技术. 性能高. 终端芯片的成本会很低. 我相信这个技术会代替电缆, 电话线, cable modem, DSL modem, 就好像wifi取代的以太网线一样. 
...
这样就可以大量有效快速培养人才,  这些也就是我在上次遍地开花里面的建议. 
</ol>
</div>
