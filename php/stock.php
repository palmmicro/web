...
function StockCompareEstResult($nv_sql, $fund_est_sql, $strStockId, $strNetValue, $strDate, $strSymbol)
{
...
function StockUpdateEstResult($nv_sql, $fund_est_sql, $strStockId, $strNetValue, $strDate)
{
