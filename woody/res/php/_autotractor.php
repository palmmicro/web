...
function _echoAutoTractor()
{
    ...
    EchoOrderList($str);
	$str = '在本页面下载银河拖拉机自动化PC软件脚本的3个文件到同一个子目录下, 分别是'.GetFileLink('/debug/autoitscript/yinhe.au3').' '.GetFileLink('/debug/autoitscript/yinheaccounts.au3').'和'.GetFileLink('/debug/autoitscript/Tesseract.au3');
    ...
    EchoOrderList($str);
	$str = '运行AutoIt3.exe, 它会提示输入文件, 给它yinhe.au3. 会看到它会自动运行<b>海王星单独委托版</b>, 一步步在每个yinheaccount.au3中账号的6个深市账户各自申购100块华宝油气(SZ162411), 最后退出. ';
