...
{
	$ar = array(ADR_PAGE => '通过比较中国企业在美国发行的American Depositary Receipt(ADR)的中国A股价格, 港股价格和美股价格, 分析各种套利对冲方案, 提供合并交易记录.',
				  ...
				  'chinaetf' => '这里计算各种中国A股指数基金的净值, 同时分析比较各种套利对冲方案, 提供合并交易记录. 包括美股ASHR和多家国内基金公司的A股沪深300指数基金的配对交易等.',
				  ...
				  'goldetf' => '中国A股的交易者普遍不理性, 当A股大跌的时候, 完全不相关的黄金白银基金也经常会跟着跌, 这样会产生套利机会. 这里计算各种黄金白银基金的净值, 同时分析比较各种套利对冲方案, 提供合并交易记录.',
				  ...
				  'lof' => '中国A股的QDII基金是个奇葩设计, 加上A股交易者普遍的不理性, 产生了很多套利机会. 这里计算各种QDII的净值, 同时分析比较各种套利对冲方案, 提供合并交易记录.',
