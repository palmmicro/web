...
function _getMetaDescriptionStr($strPage)
{
	$ar = array('abcompare' => AB_COMPARE_DISPLAY.'工具，按A/B价格比和B/A价格比排序。B股的正式名称是人民币特种股票，以外币认购和买卖，在中国上海和深圳证券交易所上市交易。',
				  ...
				  'goldsilver' => '当A股大跌的时候, 完全不相关的'.GOLD_SILVER_DISPLAY.'基金也经常会跟着跌, 这样会产生套利机会. 这里计算各种黄金白银基金的净值, 同时分析比较各种套利对冲方案.',
				  ...
				  'qdiijp' => '四个跟踪日经225指数的'.QDII_JP_DISPLAY.'上市好几年来一直不愠不火，直到最近有人趁巴菲特光环和易方达因为中丐互怜缺QDII额度的机会拉场内溢价，让我觉得不能再观望下去了！',
				  'qdiimix' => '采用跟踪成分股变化的方式对同时有美股、港股和A股持仓的中丐互怜等'.QDII_MIX_DISPLAY.'基金进行净值估算，这样参考估值可以反应白天港股和A股波动对净值的影响。',
