...
{
    echo 'Sapphire 30 Days Photos - Yellow Series';
}

function EchoMetaDescription($bChinese)
{
	echo 'Sapphire 30 days photos. Yellow series. Taken by professional photographers from Shenzhen Far East International Medical Center.';
}
