...
{
    echo 'Sapphire 30 Days Photos - Blue Series';
}

function EchoMetaDescription($bChinese)
{
	echo 'Sapphire 30 days photos. Blue series. Taken by professional photographers from Shenzhen Far East International Medical Center.';
}
