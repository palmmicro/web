...
<ol>
  <li><a href="../../../ar1688/software.html">Download</a> an AR1688 software API.
  <li>Extract the compressed file to c:\sdcc.
  <li>Enter command line c:\sdcc\bin.
  <li>Run cmd: "getopt xxx.xxx.xxx.xxx".
  <li>Modify "admin_pin" field (where password is stored) in the options.txt file.
  <li>Run cmd: "setopt xxx.xxx.xxx.xxx".
</ol>
<br />Both getopt.bat and setopt.bat use tftp.exe, make sure your Windows system had it installed.
...
<ol>
  <li>Set the "IP Address in Chip" and use PalmTool "Phone Settings" to access the device directly. If it can connect, users can simply change those password in the settings dialog.
  <li>When "debug" option is disabled. PalmTool can not be used to access the device. Users will get error information like "Can not connect to Palm1".
...
<br />What happens if our web site <a href="../../../account/login.php">login</a> password is forgotten? Just visit password <a href="../../../account/reminder.php">reminder</a> page,
