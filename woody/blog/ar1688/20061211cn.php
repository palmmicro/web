...
<tr><td>我们为所有的<a href="../../../ar1688/indexcn.html">AR1688</a>网络电话生产厂家和用户提供软件API. API包括源代码和目标文件, 利用API用户可以为自己的网络电话定制升级文件.
我们不提供全部的源代码, 因为我们不鼓励其它人把它移植到AR1688的竞争芯片上. DSP部分是以.dat的二进制文件提供的. 底层寄存器的控制, 网络MAC层, IP层和基本的UDP和TCP的实现部分是以SDCC目标.o文件提供的. 
<br />我们使用开放源代码的SDCC编译器编译软件并且提供基于GPL版权协议的软件API, 其目的是为了帮助最终用户更好的使用他们的网络电话. 就我自己而言, 修改一些软件然后看它立刻开始工作是一件开心的事情, 我相信其它人也会有同感. 
如果每个人都能修改自己的网络电话功能, 我们还希望会因此减少定制软件的技术支持工作. 当然最重要的是, 世界上天才程序员这么多, 如果有一些能够关注和帮助我们的开发, 我们显然能够比自己关起门开发提供更好的产品. 
