...
<ol>
  <li>用最新的AR1688软件<a href="20061211cn.php">API</a>, 如果没有的话给我们<a href="mailto:support@palmmicro.com">写信</a>.
  <li>同时写信给我们说你需要特殊的软件修改MAC地址, 给我们提供升级软件必要的信息如<a href="20061014cn.php">硬件型号</a>, 协议和<a href="20070405cn.php">语言</a>.
  <li>按住*键加电, 让你的<a href="../../../ar1688/indexcn.html">AR1688</a>话机进入安全模式.
  <li>用API中SDCC\bin下的命令行, <i>getopt 192.168.1.200</i>, 结束后会弹出<b>options.txt</b>.
  <li>在<b>options.txt</b>找到类似于<i><b>mac_address=0x00,0x18,0x1f,0x10,0xa0,0xb8</b></i>的行, 修改你自己想要的MAC地址.
  <li>保存<b>options.txt</b>, 用命令行<i>setopt 192.168.1.200</i>, 话机会在修改后重新启动.
  <li>在普通模式下, 用命令行更新我们邮件发给你的特殊升级软件, 类似于<i>tftp -i xxx.xxx.xxx.xxx put ar168f_sip_us_mac_017037.bin</i>. 文件大小为640k.
  <li>在普通模式下, 用命令行更新我们邮件发给你的安全模式升级软件, 类似于<i>tftp -i xxx.xxx.xxx.xxx put ar168f_none_us_017037.bin</i>, 文件大小为64k.
</ol>
