...
总是有人问<font color=gray>怎么把显示屏上的<a href="../../../ar1688/user/gp1266cn.html">GP1266</a>字样改成我自己的字符串</font>? 刚刚我又读了一封这种邮件, 于是开始写这篇文章. 
...
<ol>
  ...
  <li>不要在新文件中做类似于<font color=gray>UDP_SOCKET _pTestSocket = NULL;</font>这样的全局变量初始化(也不要在其它老文件中加全局变量初始化), 把初始化代码放在例如<i>SntpInit</i>这样的函数中. 
...
为简化更新过程, 我们现在支持类似于<font color=gray>tftp -i xxx.xxx.xxx.xxx put font_alice.dat</font>的命令行来直接升级字库和IVR语音提示文件. 
