...
<p>2017年3月9日
<br />因为注意到^SPSIOP和XOP<a href="20150818cn.php#calibration">自动校准</a>的数据异乎寻常的多, 让我发现了从去年11月中旬开始, 
就有一个网络爬虫从相连的2个IP地址以每秒2次的频率自动爬<a href="../../res/sz162411cn.php">华宝油气净值</a>等4个页面, 持续爬了快4个月了. 在惊讶之余,
我的第一反应是每个月9.99美元的<a href="20100529cn.php">Yahoo网站服务</a>太值了, 处理如此辛勤的爬虫, 竟然没有让我这种最常用用户感觉到任何性能上的变化, 看来未来即使正常访问量提高100倍都能应付过来.
<br />我的第二反应, 是赶快加了一个对单个IP地址访问<a href="../palmmicro/20080326cn.php">Palmmicro.com</a>的次数统计. 每当访问次数累计到1000次就强制要求<a href="20100905cn.php">登录</a>一次.
...
<?php
    EchoInterpretationTable(array(array('0', '0.645',  'T-1日官方公布的净值'),
                                   array('1', '2017-03-07', 'T-1日日期'),
                                   array('2', '0.6267', 'T日预估官方净值'),
                                   array('3', '2017-03-08', 'T日日期'),
                                   array('4', '0.6267', '<a href="20170305cn.php">SZ162411的参考估值</a>'),
                                   array('5', '0.6267', '实时<a href="20150818cn.php#realtime">考虑当日CL交易情况后的T+1估值</a>'),
                                   array('6', '0.643', '当前交易价格')
                                   ), 'netvalue', true);
?>
<br />最后补充一点, 因为我估值软件每分钟才从新浪等处取一次股票交易数据, 所以爬虫每秒都来爬是没有任何意义的, 每分钟来爬一次足够了.
</p>
