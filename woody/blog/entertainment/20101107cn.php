...
<ol>
  <li>实际上5月份的时候我就想把MSN空间的日志搬到公司网站了. 当时我在自己主页上开始日志, 把MSN空间做为备份. 但是巨大的搬家工作量让我犹豫不前, 很高兴微软最终帮我做了选择.
  <li>国内访问wordpress.com不是被封杀了就是特别慢. 而且我看不出在可以预见的将来它有什么理由不会被<a href="../palmmicro/20100427cn.php">GFW</a>封杀.
  <li>自动转换到wordpress.com的效果并不像宣传的那么好. 转换后的文本中丢失了很多' ', '\0'和'''之类的字符. 另外在中文下显示的时候, wordpress会自作聪明的把很多标点符号转换成中文版本, 让整个页面看上去蠢死了.
</ol>
<br /><a href="../../../tangli/index.html">唐丽</a>也在把自己的MSN空间往Palmmicro网站搬. 新加了这么多页面后, 我们网站接下来的访问统计数据估计会大大增加.
