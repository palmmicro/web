...
<p>2018年4月19日
<br /><a href="#qcloud">腾讯云</a>上的PHP调试环境安装好后用得并不多. 不过因为我一开始就懒于在它上面做用户界面, 而是只用命令行方式的<?php EchoFileLink(DebugGetTestFile()); ?>,
无意中在<a href="20161020cn.php#ahcompare">微信公众号</a>后又给了自己一个隔离数据和用户界面的机会, 调整了不少代码结构.
...
发现系统更新到了CentOS 6.9 -- 刚好是腾讯云官方镜像还继续支持的一个版本!
</p> 
