...
<p>2012年7月19日
<br />1997年, 当我在Fremont完成Windows下的H.324<a href="../pa6488/20110524cn.php">视频</a>电话后, ESS的工程师们问我下一步打算怎么把它移植到他们的DVD芯片上.
...
不过, 我在ESS认识了王老板, 从此继续了不使用操作系统开发嵌入式应用的工作方式, 从<a href="../../../pa1688/indexcn.html">PA1688</a>到<a href="../../../ar1688/indexcn.html">AR1688</a>和PA6488.   
...
<br /><font color=gray>The truth is I never left you -- Don't Cry for Me Argentina</font>
</p>
...
一下子修改测试<a href="20150818cn.php">华宝油气净值</a>工具PHP代码的效率变得特别低, 让我苦恼无比.
<br />这两天刚好读了篇有关云服务的文章, 让我想到了干脆自己弄个云服务器, 自己搭建一个PHP测试环境, 测试好的代码再上传<?php echo GetBlogLink(20080326) ?>.com.
...
<ol>
  ...
  <li>按<?php EchoExternalLink('https://www.biaodianfu.com/centos-6-7-install-amh-4-2.html'); ?>中的步骤, root登录后运行yum update更新系统, 然后运行yum install wget安装wget.</li>
...
无意中在<?php echo GetBlogLink(20161014) ?>后又给了自己一个隔离数据和用户界面的机会, 调整了不少代码结构.
