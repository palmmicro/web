...
function EchoAll()
{
	...
	EchoBlogDate();
    echo <<<END
<br />随着{$strSZ159501}今天开始交易，场内{$strNasdaq100}基金已经到了两只手都要数不过来的边缘，而其中一半都是今年新开的，可见其受欢迎的程度。
...
$strImage
<br />这是在写之前尽我所能的截屏。芝商所的数据延迟十分钟，{$strSnowball}数据基本上是实时的。可以看出，6月16日结算的合约(14983)跟现货(十分钟前大约14980)比已经只有很少的升水，但是九月合约相对于六月有(15169/14983=1.012)大约1.2%的升水。十二月相对于九月也是同样1.2%的升水。
