...
function Echo20161020($strHead)
{
	...
	$strHead
<p>2016年10月20日
<br />今天发现有个{$strWechat}公众号用户用语音查询{$strQuote}，没查到因为数据库中根本没有它。不过因此刺激了我给加上查询所有股票交易数据的功能。
...
<br />这些基金的实时估值使用的是新浪数据中的{$strNdx}期货NQ。新浪的期货数据总是提供所谓的主力合约，也就是说它可能会切换得较早。比如NQ的数据，新浪在前两天就切换到了九月到期的合约。最近一年来，每当这种时候总有人问，为什么实时估值高那么多？
<br />因为随着美元的加息，纳斯达克100和标普500的期货一直在持续升水。
$strImage
</p>
<p>这是在写之前尽我所能的截屏。芝商所的数据延迟十分钟，雪球数据基本上是实时的。可以看出，6月16日结算的合约(14983)跟现货(十分钟前大约14980)比已经只有很少的升水，但是九月合约相对于六月有(15169/14983=1.012)大约1.2%的升水。十二月相对于九月也是同样1.2%的升水。
<br />大家都喜欢说期货反应预期，所以这个升水很容易被解读成群众相信美股永远涨，但是这是错误的。就像我在2020年写的原油期货升水和油轮运费的关系一样，升水反应的是套利者之间的博弈。
