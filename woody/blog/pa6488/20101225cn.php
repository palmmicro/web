...
<tr><td>1999年的时候我写了第一个非PC上跑的软件, 用来管理<a href="../palmmicro/20080326cn.php">Palmmicro</a> Palm1硬件中SDRAM的FAT文件系统, 通过UART跟PC交换文件. 后来Palm1被叫做了<a href="../../../pa1688/indexcn.html">PA1688</a>. 
...
<br />当<a href="../../../pa6488/indexcn.html">PA6488</a>再次需要文件系统管理DRAM时, 我首先想到了我的老FAT. 不过我很快就发现这是个坏主意.
当年的我缺乏<a href="../ar1688/20080811cn.php">标准</a>意识, 最终的版本是个为代码大小和运行性能过度优化的非标准FAT, 而且代码本身组织得也很糟糕. 
