...
<br />第一次我着手用JPEG源代码是1997年跟崔导在ESS的时候. 贾博士和我一起给<a href="../palmmicro/20061123cn.php">王老板</a>写了个测试CMOS摄像头原始图像扩展算法的程序. 我用<a href="http://www.ijg.org/" target=_blank>IJG JPEG</a>版本"6a 7-Feb-96"的源代码处理JPG文件的读写. 下面的图片是这个程序的抓屏, 我当时在测试中大量的使用了宫泽理惠的图片. 
