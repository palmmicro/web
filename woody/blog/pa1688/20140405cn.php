...
<tr><td>在王老板成功故事的影响下, 差不多所有Palmmicro的早期员工都在离开<a href="../entertainment/20090219cn.php">Centrality/SiRF/CSR</a>后开了自己的公司.
...
<br />我决定添加新的<a href="../ar1688/20061014cn.php">硬件型号</a><font color=grey>EHOG</font>. 一定是因为距离上一次我真正修改PA1688软件已经很久远了, 我完全低估了这个工作.
<br />我在inc\<b>version.h</b>中加入了<b><i>VER_EHOG</i></b>, 修改了同一文件中其它相关部分, 然后开始用命令行<font color=grey>mk ehog sip cn</font>编译.
很快我发现还需要添加inc\<b>flags.h</b>中<b><i>VER_EHOG</i></b>相关部分和<b>make_hex.bat</b>中<font color=grey>ehog</font>相关部分. 改完后没有编译错误了, 但是我还是找不到编译后应该产生出来的升级文件<b>ehog_sip_cn_169006.bin</b>.
<br />检查了每一步后, 我发现还需要在PALMTOOL\P_MERGE\<b>p_merge.cpp</b>中加入<font color=grey>ehog</font>并且重新编译产生bin\<b>p_merge.exe</b>.
这下就复杂了, 因为<b>p_merge.exe</b>是用VC6编译的, 考虑到我把AR1688 Windows工具从VC6转换到<a href="../ar1688/20100818cn.php">VC2008</a>编译过程中的工作量, 我决定放弃给PA1688软件添加<font color=grey>EHOG</font>硬件型号.
