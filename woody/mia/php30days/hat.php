...
{
	return 'Sapphire 30 Days Photos - Red Hat Series';
}

function GetMetaDescription($bChinese)
{
	return 'Sapphire 30 days photos. Red Hat series. Taken by professional photographers from Shenzhen Far East International Medical Center.';
}
